 ...
 */
public interface MachineService<Object extends Machine> {
     ...
     * @return the list of machines
     */
    List<? extends Object> getAll(Class<? extends Object> type);
     ...
     */
    void fill(List<? super Object> machines, Object value);
     ...
     */
    void startWorking(List<? extends Object> machines);
}
